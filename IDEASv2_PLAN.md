...
| RA | `PROMPT_TETRIS_EXAMPLE.md` | the same, no code change | the prompt alone |
| RB | `PROMPT_TETRIS_EXAMPLE.md` | after wave 1 merged | the lift, the slice, the documents in the window, the checks |
| RC | `PROMPT_TETRIS_EXAMPLE.md` | after wave 2 merged | the documents written by the job |
...
- `scripts/nightly/asks/05-tetris.md` replaced by `PROMPT_TETRIS_EXAMPLE.md`, the old ask kept as `05-tetris-v1.md`.
