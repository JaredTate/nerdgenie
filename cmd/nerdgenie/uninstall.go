...
// folder is kept, because it holds every task, memory, skill, and secret Nerd Genie
...
var uninstallSubcommand = subcommand{
	name: "uninstall",
	help: "Stops the Nerd Genie service and removes it, keeping your home folder unless --purge is given.",
