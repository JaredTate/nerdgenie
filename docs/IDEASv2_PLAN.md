...
| RA | `EX_PROMPT_3_TETRIS.md` | the same, no code change | the prompt alone |
| RB | `EX_PROMPT_3_TETRIS.md` | after wave 1 merged | the lift, the slice, the documents in the window, the checks |
| RC | `EX_PROMPT_3_TETRIS.md` | after wave 2 merged | the documents written by the job |
...
- `scripts/nightly/asks/05-tetris.md` replaced by `EX_PROMPT_3_TETRIS.md`, the old ask kept as `05-tetris-v1.md`.
