...
// MaxStandingOrderLines is how much of a work folder's NERDGENIE.md rides in
...
const TheStandingOrderCutLine = "... cut at sixty lines; read NERDGENIE.md for the rest"
