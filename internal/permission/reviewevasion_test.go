...
var deletesWithAFlagInFront = []struct {
	...
	{"a talkative delete", "rm -v -rf /home/user/nerdgenie"},
	{"a delete that asks first", "rm -i -rf /home/user/nerdgenie"},
	{"the long spellings in the other order", "rm --force --recursive /home/user/nerdgenie"},
	{"a delete of folders written the long way round", "rm -d -r /home/user/nerdgenie"},
	{"a delete that stays on one filesystem", "rm --one-file-system -rf /home/user/nerdgenie"},
}
