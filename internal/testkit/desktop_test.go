...
func TestTheFakeDesktopRefusesAnApplicationNobodyGranted(t *testing.T) {
	...
	err := desktop.Launch(context.Background(), "gimp")
...
func TestTheFakeDesktopLaunchesAnApplicationTheUserGranted(t *testing.T) {
	...
	if err := desktop.Launch(ctx, "text-editor"); err != nil {
...
func TestTheFakeDesktopRecordsEveryAction(t *testing.T) {
	...
	steps := []struct {
		...
		{"click", func() error { return desktop.Click(ctx, 1) }},
		{"type", func() error { return desktop.Type(ctx, "the anniversary post") }},
		{"press", func() error { return desktop.Press(ctx, "ctrl+s") }},
		{"drag", func() error { return desktop.Drag(ctx, 1, 2) }},
...
func TestTheFakeDesktopRefusesAMarkThatIsNotOnTheScreen(t *testing.T) {
	...
	if err := desktop.Click(ctx, 99); err == nil {
