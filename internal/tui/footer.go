...
// extraHints answers the hints the interaction half of this screen adds, such
// as "tab focus" and "↵ expand", each as the key, a blank, and the verb. It
// is a variable rather than a plain call so that a test can stand other hints
// in; the two halves were built apart against this one seam, and the merge
// joined them here.
var extraHints = interactionHints
