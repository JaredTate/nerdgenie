...
a handoff sends to the user. Before the picture the worker brings the page's
window to the front, because a tab behind another draws nothing, and then counts
